    ...
    <div className="container mx-auto px-4 py-24 sm:py-32">
      ...
      <div className="max-w-3xl mx-auto space-y-16">
        ...
        <section>
          ...
          <blockquote className="text-xl italic text-gray-600 dark:text-gray-400 border-l-4 border-blue-500 pl-4">
            {t('philosophyContent')}
          </blockquote>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-4">
            {techStack.map((tech) => (
              <div key={tech} className="bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white px-4 py-2 rounded-full text-sm font-medium">
                {tech}
              </div>
            ))}
          </div>
        ...
        <section className="text-center pt-8">
          <a
            ...
            download
            className="inline-block px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-lg font-medium transition-colors"
          >
            {t('downloadResume')}
          </a>
        </section>
