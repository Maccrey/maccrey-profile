...
export default function ContactPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-24 sm:py-32">
      <h1 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white">Contact Me</h1>
      <div className="max-w-2xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <div className="flex justify-center gap-6">
            <a href="mailto:maccrey@naver.com" className="text-blue-600 dark:text-blue-400 hover:underline transition-colors">Email</a>
            ...
            <a href="https://code-lab.tistory.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline transition-colors">Blog</a>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-lg font-medium transition-colors disabled:bg-gray-500"
            >
              Send Message
            </button>
          </div>
